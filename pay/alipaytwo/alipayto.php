...
$out_trade_no		= $_REQUEST['ordernum'];		//请与贵网站订单系统中的唯一订单号匹配
$subject			= $_REQUEST['pname'];	//订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
$body				= $_REQUEST['pname'];	//订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
$price				= $_REQUEST['price'];	//订单总金额，显示在支付宝收银台里的“应付总额”里
...
$receive_name		= $_REQUEST['user'];			//收货人姓名，如：张三
$receive_address	= $_REQUEST['addr'];			//收货人地址，如：XX省XXX市XXX区XXX路XXX小区XXX栋XXX单元XXX号
$receive_zip		= "";				//收货人邮编，如：123456
$receive_phone		= "";		//收货人电话号码，如：0571-81234567
$receive_mobile		= $_REQUEST['mob'];		//收货人手机号码，如：13312341234
